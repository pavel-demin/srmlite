...
package ifneeded srmlite::cleanup        0.2 [list source [file join $dir cleanup.tcl]]
...
package ifneeded srmlite::frontend       0.2 [list source [file join $dir frontend.tcl]]
